...
<header class="w3-display-container w3-content" style="max-width:1500px;">
  <img class="w3-image" src="https://media.gettyimages.com/photos/indias-prime-minister-narendra-modi-president-ram-nath-kovind-and-picture-id1196446736?s=2048x2048" alt="The Hotel" style="min-width:1000px" width="1500" height="800">
...
<div class="w3-content" style="max-width:1532px;">
  ...
  <div class="w3-row-padding w3-padding-16">
    <div class="w3-third w3-margin-bottom">
      <img src="https://media.gettyimages.com/photos/indias-prime-minister-narendra-modi-president-ram-nath-kovind-and-picture-id1196446736?s=2048x2048" alt="Norway" style="width:100%">
  ...
  <div class="w3-row-padding" id="about">
    ...
    <div class="w3-col l8 12">
      ...
      <img src="https://media.gettyimages.com/photos/indias-prime-minister-narendra-modi-president-ram-nath-kovind-and-picture-id1196446736?s=2048x2048" class="w3-image w3-greyscale" style="width:100%;">
    </div>
  </div>
  ...
  <div class="w3-row-padding w3-padding-16 w3-text-white w3-large">
    <div class="w3-half w3-margin-bottom">
      <div class="w3-display-container">
        <img src="https://media.gettyimages.com/photos/indias-prime-minister-narendra-modi-president-ram-nath-kovind-and-picture-id1196446736?s=2048x2048" alt="Cinque Terre" style="width:100%">
    ...
    <div class="w3-half">
      <div class="w3-row-padding" style="margin:0 -16px">
        <div class="w3-half w3-margin-bottom">
          <div class="w3-display-container">
            <img src="https://media.gettyimages.com/photos/indias-prime-minister-narendra-modi-president-ram-nath-kovind-and-picture-id1196446736?s=2048x2048" alt="New York" style="width:100%">
            <span class="w3-display-bottomleft w3-padding">New York</span>
          </div>
        </div>
        <div class="w3-half w3-margin-bottom">
          <div class="w3-display-container">
            <img src="https://media.gettyimages.com/photos/indias-prime-minister-narendra-modi-president-ram-nath-kovind-and-picture-id1196446736?s=2048x2048" alt="San Francisco" style="width:100%">
      ...
      <div class="w3-row-padding" style="margin:0 -16px">
        <div class="w3-half w3-margin-bottom">
          <div class="w3-display-container">
            <img src="https://media.gettyimages.com/photos/indias-prime-minister-narendra-modi-president-ram-nath-kovind-and-picture-id1196446736?s=2048x2048" alt="Pisa" style="width:100%">
            <span class="w3-display-bottomleft w3-padding">Pisa</span>
          </div>
        </div>
        <div class="w3-half w3-margin-bottom">
          <div class="w3-display-container">
            <img src="https://media.gettyimages.com/photos/indias-prime-minister-narendra-modi-president-ram-nath-kovind-and-picture-id1196446736?s=2048x2048" alt="Paris" style="width:100%">
...
<div class="w3-half w3-container">
  <div class="w3-topbar w3-border-amber">
    <img src="https://media.gettyimages.com/photos/indias-prime-minister-narendra-modi-president-ram-nath-kovind-and-picture-id1196446736?s=2048x2048" style="width:100%">
...
<div class="w3-half w3-container">
 ...
 <!-- Pagination -->
  <div class="w3-center w3-padding-32">
    <div class="w3-bar">
      <a href="temp5.php" class="w3-bar-item w3-button w3-hover-black w3-red">«PREVIOUS</a>
      <a href="temp1.php" class="w3-bar-item w3-hover-black w3-button">1</a>
      ...
      <a href="temp6.php" class="w3-bar-item w3-button w3-teal w3-hover-black">6</a>
      <a href="temp7.php" class="w3-bar-item w3-button w3-hover-black">7</a>
      <a href="temp7.php" class="w3-bar-item w3-button w3-hover-black w3-red">NEXT»</a>
    </div>
  </div>
